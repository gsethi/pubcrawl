...
public class SingleCountCrawl {
    ...
    public static class SingleCountItem{
     ...
     public static void main(String[] args) throws Exception {
         ...
         System.out.println("about to parse CLI");
         ...
         System.out.println("loading keeplist filename");
    ...
    public static ArrayList getTermList(){
        ...
        try{
         ...
         //end of loop, so add last termconcatlist
            ...
            System.err.println("Error retrieving terms from database. Reason: " + ex.getMessage());
            System.exit(1);
        }
