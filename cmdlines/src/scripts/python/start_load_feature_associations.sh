...
then
	...
	echo "ie sh create_parse_load_rface_rgx.sh /titan/cancerregulome3/TCGA/outputs/brca/brca.merge.agil.14sep.hg18.tsv /titan/cancerregulome9/workspaces/users/sreynolds/brca/rfAce.test.01/associations.out brca_0914 .05 1 /brca/brca_pairwise_associations.tsv"
	exit
fi
dataset_label=$1
